...
# --- Parameters available for MLP-PINN ---
# ['activation', 'learning_rate', 'n_hidden_layers', 'optimizer', 'physical_loss_weight', 'units_layer1', 
# 'units_layer2', 'units_layer3', 'units_layer4', 'units_layer5', 'units_layer6', 'units_layer7']

# --- Parameter to plot ---
param_name = 'units_layer1'
upper_bounds = [1e-4, 1e-6]

# --- Optimization study information ---
study_name = 'mlp_pinn_study'
storage = 'sqlite:///optimization-plots/data_optimization_results/mlp_pinn_study.db'
...
def plot_parameter_impact_by_objective(study: optuna.study.Study, objective:str, param_name:str, 
   ...
   # --- Define layout-specific plotting parameters ---
    ...
    naming_dict = {'activation': 'Activation function', 'learning_rate': 'Learning rate', 
        ...
        'physical_loss_weight': 'Physical loss weight'}
