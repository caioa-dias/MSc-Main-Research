...
def data_surface_visualization(data:pd.DataFrame, Re:int, AoA:int, surface:str, out_path:str):
    """
    ...
    if surface == 'upper':
        title_text = f'Pressure Coefficient Distribution at Re = {Re} and AoA = {AoA}° - Upper Surface'
        view_elev = 30
    else:
        title_text = f'Pressure Coefficient Distribution at Re = {Re} and AoA = {AoA}° - Lower Surface'
        view_elev = -30
