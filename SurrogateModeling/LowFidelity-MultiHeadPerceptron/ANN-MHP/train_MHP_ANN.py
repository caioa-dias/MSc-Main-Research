...
def build_model(input_dim: int, cl_output_dim: int, cp_output_dim: int):
    ...
    x = keras.layers.Dense(units=128, activation='gelu', kernel_initializer='glorot_uniform', 
    ...
    h1 = keras.layers.Dense(units=96, activation='gelu', kernel_initializer='glorot_uniform',
        name='Cl_Layer_1')(x)
    #h1 = keras.layers.Dense(units=128, activation='swish', kernel_initializer='glorot_uniform',
        #name='Cl_Layer_2')(h1)
    ...
    h2 = keras.layers.Dense(units=160, activation='swish', kernel_initializer='glorot_uniform',
        name='Cp_Layer_1')(x)
    #h2 = keras.layers.Dense(units=192, activation='swish', kernel_initializer='glorot_uniform',
        #name='Cp_Layer_2')(x)
    ...
    # --- Compiling the model ---
    model.compile(loss={'Cl_Output': 'mse', 'Cp_Output': 'mse'}, optimizer=keras.optimizers.Nadam(learning_rate=0.0015), 
        metrics={'Cl_Output': ['mae'], 'Cp_Output': ['mae']}, loss_weights={'Cl_Output': 0.313426551734879, 'Cp_Output': 1-0.797609919048461})
