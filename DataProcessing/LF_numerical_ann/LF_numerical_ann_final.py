...
def build_model(input_shape: Tuple[int], output_shape: int):
    ...
    model = Sequential([
        ...
        Dense(160, activation='swish', name='Hidden_Layer_2'),
        BatchNormalization(),
        ...
        Dense(224, activation='swish', name='Hidden_Layer_4'),
        BatchNormalization(),

        Dense(192, activation='swish', name='Hidden_Layer_5'),
        BatchNormalization(),
    ...
    model.compile(loss='mean_squared_error', optimizer=Nadam(learning_rate=0.01), metrics=['mae'])
...
def save_results(model: Sequential, history: History, X_test: np.ndarray, Y_test: np.ndarray, Y_pred: np.ndarray, 
    ...
    # Saving the plot:
    plt.tight_layout()
    plt.savefig('LF_numerical_ann/plots/training_history_loss.png', dpi=300)
    plt.close()
    ...
    # Saving the plot:
    plt.tight_layout()
    plt.savefig('LF_numerical_ann/plots/training_history_mae.png', dpi=300)
    plt.close()
    ...
    # Saving the plot:
    plt.tight_layout()
    plt.savefig('LF_numerical_ann/plots/predictions_overall.png', dpi=300)
    plt.close()
    ...
    # Saving the plot:
    plt.tight_layout()
    plt.savefig('LF_numerical_ann/plots/predictions_cl.png', dpi=300)
    plt.close()
    ...
    # Saving the plot:
    plt.tight_layout()
    plt.savefig('LF_numerical_ann/plots/predictions_cp.png', dpi=300)
    plt.close()
    ...
    # Saving the plot:
    plt.tight_layout()
    plt.savefig('LF_numerical_ann/plots/model_sensitivity_cl.png', dpi=300)
    plt.close()
    ...
    # Saving the plot:
    plt.tight_layout()
    plt.savefig('LF_numerical_ann/plots/model_sensitivity_cp.png', dpi=300)
    plt.close()
